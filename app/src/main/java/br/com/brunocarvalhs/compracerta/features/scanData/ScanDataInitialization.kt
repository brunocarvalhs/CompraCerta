package br.com.brunocarvalhs.compracerta.features.scanData

import androidx.compose.ui.Modifier
import androidx.navigation.NavGraphBuilder
import androidx.navigation.NavHostController
import br.com.brunocarvalhs.compracerta.features.home.commons.navigation.homeGraph
import br.com.brunocarvalhs.compracerta.features.scanData.commons.navigation.scanDataGraph

class ScanDataInitialization(private val builder: Builder) {

    fun initialize() {
        builder.navGraphBuilder?.scanDataGraph(
    ...
    class Builder {
        ...
        fun build() = ScanDataInitialization(this).initialize()
    }
}